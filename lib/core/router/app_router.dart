    ...
    routes: [
      ...
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(
            path: '/app/exams',
            builder: (_, __) => const EligibilityFinderScreen(),
          ),
          GoRoute(
            path: '/app/tools',
            builder: (_, __) => const ExamPathBuilderScreen(),
          ),
          GoRoute(
            path: '/app/blog',
          ...
          GoRoute(
            path: '/app/cutoff-analyzer',
            builder: (_, __) => const CutoffAnalyzerScreen(),
          ),
          GoRoute(
            path: '/app/test-series',
            builder: (_, __) => const TestListScreen(),
          ),
          GoRoute(
            path: '/app/test/:id',
            builder: (_, state) => TestActiveScreen(
              testId: state.pathParameters['id']!,
            ),
          ),
          GoRoute(
            path: '/app/test/:id/result',
            builder: (_, state) => TestResultScreen(
              result: state.extra as TestResultEntity,
            ),
          ),
          GoRoute(
